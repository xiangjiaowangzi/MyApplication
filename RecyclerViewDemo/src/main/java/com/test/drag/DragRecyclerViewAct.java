...
public class DragRecyclerViewAct extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drag_actvity);
        ...
        mRecyclerView.addOnItemTouchListener(new OnRecyclerItemClickListener(mRecyclerView) {
            ...
            public void onItemClick(RecyclerView.ViewHolder vh) {
                if (vh.getAdapterPosition() == 0){
                    myAdapter.notifyItemMoved(3, 8);
                }
                Toast.makeText(DragRecyclerViewAct.this, datas.get(vh.getLayoutPosition()).getTitle(), Toast.LENGTH_SHORT).show();
            }
